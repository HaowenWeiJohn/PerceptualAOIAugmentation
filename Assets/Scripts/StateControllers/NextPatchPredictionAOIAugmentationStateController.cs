...
public class NextPatchPredictionAOIAugmentationStateController : StateController
{
    ...
    public override void enterState()
    {
        ...
        aOIAugmentationStateGUIController.activateNextPatchPredictionAOIAugmentationOverlayController();
    ...
    public override void exitState()
    {
        ...
        aOIAugmentationStateGUIController.deactivateNextPatchPredictionAOIAugmentationOverlayController();
